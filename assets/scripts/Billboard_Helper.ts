...
import { _decorator, Component, Node, BillboardComponent, Vec4, renderer, Material, Mesh, EffectAsset, utils, gfx, director } from 'cc';
const { ccclass, property } = _decorator;

@ccclass('BillboardHelper')
export class BillboardHelper extends BillboardComponent {
